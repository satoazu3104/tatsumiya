...
registerBlockType('portart/dectitle', {
  title: 'デコレーション文字',
  icon: 'smiley',
  category: 'layout',
  attributes: {
  ...
  save: ({ className, attributes: { text, variation, fontfamily, addId, addClassName } }) => {
    ...
    return (
      <>
        <div class="p-dec__title__wrap">
          <div class="p-dec__title--dot left-top"></div>
          <div class="p-dec__title--dot left-bottom"></div>
          <div class="p-dec__title--dot right-top"></div>
          <div class="p-dec__title--dot right-bottom"></div>
          
          <div class="p-dec__title__img"></div>
